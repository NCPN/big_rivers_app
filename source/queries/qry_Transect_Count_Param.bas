Operation =1
Option =0
Having ="(((tbl_Locations.Unit_Code)=[Forms]![frm_Select_Transect_Counts]![Park_Code]) AN"
    "D ((Year([Start_Date]))=[Forms]![frm_Select_Transect_Counts]![Visit_Year]))"
Begin InputTables
    Name ="tbl_Locations"
    Name ="tbl_Events"
...
dbBinary "GUID" = Begin
    0xb1b517a4cc20d6438804e02cad1f090d
End
Begin
    Begin
