        ...
        Begin Section
            ...
            Begin
                ...
                Begin CommandButton
                    ...
                    OnClick ="[Event Procedure]"
                    FontName ="Arial"
                    ControlTipText ="Open the sample schedule browser"
                    UnicodeAccessKey =83
                ...
                Begin CommandButton
                    ...
                    OnClick ="[Event Procedure]"
                    FontName ="Arial"
                    ControlTipText ="View and enter incidental observation data"
                    UnicodeAccessKey =73
                ...
                Begin CommandButton
                    ...
                    OnClick ="[Event Procedure]"
                    FontName ="Arial"
                    ControlTipText ="Enter field season training notes"
...
' =================================
' FORM NAME:    fsub_DbAdmin
' Description:  Subform navigator for database admin tasks
' Data source:  unbound
' Data access:  N/A
' Pages:        none
' Functions:    none
...
'               BLC, 8/5/2014  - fixed runtime error 94 (invalid use of NULL) on HasAccessBE TempVar
