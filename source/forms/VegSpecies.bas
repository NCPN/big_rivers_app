        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    BorderColor =10921638
                    Name ="list"
                    SourceObject ="Form.VegSpeciesList"
                    GridlineColor =10921638
...
' Basis:        Dropdown form
'
' Description:  VegSpecies form object related properties, functions & procedures for UI display
'
...
'               BLC - 10/21/2016 - 1.02 - removed ButtonCaption, SelectedID, SelectedValue properties,
'                                         use GetContext()
...
'                                         renamed to VegSpecies to separate out walk specific data
' =================================
...
On Error GoTo Err_Handler
    ...
    Select Case Me.FormContext
        ...
        Case "VegSpecies"
            'expose event, start date for VegSpecies form
    ...
    Title = IIf(strCaller = "VegPlot", strTitle, "VegSpecies")
...
'    cbxEvent.ColumnWidths = "0;0;0;0;2"
    ...
    'columns: Master_PLANT_Code, LU_Code, Utah_species, ddSpecies (LU_code (Utah_species))
    cbxSpecies.BoundColumn = 1 'bind to label (not ID)
    cbxSpecies.ColumnCount = 4
    cbxSpecies.ColumnHeads = True
    'cbxSpecies.ColumnWidths = "0;.7in;.2in;0;0" 'display the display column (combines label - summary)
    'display: LU code & Utah species (ddSpecies column) but record Master plant code
    cbxSpecies.ColumnWidths = "0;.7in;.7in;0" 'display LU code & Utah sp vs display column (combines label - summary)
    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Open[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Load[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Current[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - cbxEvent_AfterUpdate[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - cbxSpecies_AfterUpdate[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - chkIsSeedling_AfterUpdate[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnUndo_Click[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnSave_Click[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnAddEvent_Click[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnAddUnknown_Click[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnSpeciesSearch_Click[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnSetObserverRecorder_Click[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
' Revisions:
'   BLC - 8/2/2016 - initial version
'   BLC - 10/25/2016 - revised to use strFormContext vs. VegSpecies
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnComment_Click[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Close[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ReadyForSave[VegSpecies form])"
    End Select
    Resume Exit_Handler
End Sub
