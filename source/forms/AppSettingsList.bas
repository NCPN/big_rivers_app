    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Open[AppSettingsList form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Load[AppSettingsList form])"
    End Select
    Resume Exit_Handler
End Sub

' ---------------------------------
' Sub:          tbxFormName_Click
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - tbxFormName_Click[AppSettingsList form])"
    End Select
    Resume Exit_Handler
End Sub

' ---------------------------------
' Sub:          tbxFormName_DblClick
' Description:  Link click event actions
' Assumptions:  -
' Parameters:   -
' Returns:      -
...
' ---------------------------------
Private Sub tbxFormName_DblClick(Cancel As Integer)
On Error GoTo Err_Handler
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - tbxFormName_DblClick[AppSettingsList form])"
    End Select
    Resume Exit_Handler
End Sub
...
'   BLC - 7/30/2016 - initial version
' ---------------------------------
Private Sub tbxFormName_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
On Error GoTo Err_Handler
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - tbxFormName_MouseMove[AppSettingsList form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Detail_MouseMove[AppSettingsList form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Close[AppSettingsList form])"
    End Select
    Resume Exit_Handler
End Sub
