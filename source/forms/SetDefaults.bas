    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Open[SetDefaults form])"
    End Select
    Resume Exit_Handler
End Sub
...
' Source/date:  John Boetsch - NCCN Landbirds db
' Adapted:      Bonnie Campbell, May 2014 for NCPN WQ Utilities tool
' Revisions:    BLC - 6/30/2014 - updated for big rivers
' ---------------------------------
...
'               BLC - 6/30/2014 - updated for big rivers
' ---------------------------------
