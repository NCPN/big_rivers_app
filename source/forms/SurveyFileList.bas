...
Begin Form
    ...
    RecSrcDt = Begin
        0xbff26ff9d5cee440
    End
    RecordSource ="SurveyDataSourceFile"
    Caption ="_List"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    BorderColor =10921638
                    ForeColor =4138256
                    Name ="tbxSurveySource"
                    ControlSource ="SurveySource"
                    GridlineColor =10921638
    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Open[SurveyFileList form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Load[SurveyFileList form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Current[SurveyFileList form])"
    End Select
    Resume Exit_Handler
End Sub

' ---------------------------------
' Sub:          tbxFilename_Click
' Description:  filename click actions
' Assumptions:  -
' Parameters:   -
' Returns:      -
' Throws:       none
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - tbxFilename_Click[SurveyFileList form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnEdit_Click[SurveyFileList form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnDelete_Click[SurveyFileList form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Close[SurveyFileList form])"
    End Select
    Resume Exit_Handler
End Sub
