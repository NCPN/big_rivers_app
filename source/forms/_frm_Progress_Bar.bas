...
'  Properties
'=================================================================
' See mod_App_Settings for PROGRESS_BAR color setting
...
' Description:  Increase the percent value for the progress bar
' Assumptions:  none
' Parameters:   sPercentComplete - value (single)
'               strDescription - label (string)
' Returns:      N/A
' Throws:       none
' References:   none
' Source/date:  http://archive.oreilly.com/pub/h/2607
...
Me.lblMsg.Caption = strDescription
Me.Repaint
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Increment[form_frm_Species_Search])"
    End Select
