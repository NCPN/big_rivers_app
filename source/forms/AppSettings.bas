        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    BorderColor =10921638
                    Name ="list"
                    SourceObject ="Form.AppSettingsList"
                    GridlineColor =10921638
...
' Basis:        Dropdown form
'
' Description:  List form object related properties, AppSettings, functions & procedures for UI display
'
    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Open[AppSettings form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Load[AppSettings form])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Close[AppSettings form])"
    End Select
    Resume Exit_Handler
End Sub
